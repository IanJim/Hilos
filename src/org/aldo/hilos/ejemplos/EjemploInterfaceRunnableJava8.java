...
public class EjemploInterfaceRunnableJava8 {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread v2 = new Thread(viaje, "Robinos Crusoe");
        ...
        // el método join se ejecuta en la instancia y el metodo sleep() es estático,
        // se ejecuta en donde esta puesto en el hilo
